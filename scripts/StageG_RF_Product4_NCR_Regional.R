# Full NCR + Regional rerun using RF Product 4: empirical rainfall STA/LTA R(t)
# preceding the first Outbreak Threshold trigger.
.run_rf_product4 <- function() {
  ...
  Sys.setenv(TA_RF_GATE_PRODUCT="4", TA_OUTPUT_SUFFIX="_RF_Product4")
